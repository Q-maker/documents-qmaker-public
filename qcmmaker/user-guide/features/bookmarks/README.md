...
![Add a question from Challenge mode](images/add-from-challenge.jpg)
...
![Add a question from correction](images/add-from-correction.jpg)
...
![Preview bookmark list](images/preview-bookmark-list.jpg)

When the chooser appears, select the bookmarks you want to use.

![Bookmark chooser](images/bookmark-chooser.jpg)
