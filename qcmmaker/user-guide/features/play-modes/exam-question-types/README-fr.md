...
![Sélection vide](images/selection-empty.png)

![Sélection corrigée avec succès](images/selection-correction-success.png)

![Sélection partiellement correcte](images/selection-correction-partial.png)

### Réponse textuelle

![Réponse textuelle renseignée](images/typed-answer-filled.png)

![Réponse textuelle incorrecte](images/typed-answer-correction-failure.png)

### Texte à trous

![Texte à trous vide](images/fill-in-blanks-empty.png)

![Texte à trous partiellement correct](images/fill-in-blanks-correction-partial.png)

### Énumération

![Énumération renseignée](images/enumeration-filled.png)

![Énumération corrigée avec succès](images/enumeration-correction-success.png)

### Association de colonnes

![Association de colonnes renseignée](images/match-columns-filled.png)

![Association partiellement correcte](images/match-columns-correction-partial.png)

### Remise en ordre

![Séquence renseignée](images/put-in-order-filled.png)

![Séquence incorrecte](images/put-in-order-correction-failure.png)

### Mots mélangés

![Phrase reconstruite](images/jumbled-words-filled.png)

![Phrase corrigée avec succès](images/jumbled-words-correction-success.png)
