...
The Settings screen groups the main app preferences: language, interface customization, workspace setup, and quiz player behavior.
...
| Interface customization | Theme, default sorting, Home shortcuts, play launch behavior, and quiz options menu style. | [App customization settings](workspace-behaviour/README.md) |
