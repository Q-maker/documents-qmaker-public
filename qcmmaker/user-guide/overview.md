...
| **Play modes** | Play a quiz in **Exam** mode (timed, feedback at end) or **Challenge** mode (immediate per-question feedback). Choose a mode before playing, configure which modes a quiz supports, review correction and score after completion, use the [Exam question type reference](features/play-modes/exam-question-types/README.md) or [Challenge question type reference](features/play-modes/challenge-question-types/README.md) to preview captured question families, and see [Challenge result and replay](features/play-modes/challenge-result-replay.md) for retake options. | [features/play-modes/](features/play-modes/README.md) |
