...
![Workspace actions menu](images/workspace-actions-menu.png)

Enter a quiz name, keep the main workspace selected, then tap **CREATE**.

![Create quiz dialog](../features/create-quiz/images/dialog-create-quiz.png)

Good to know: the name becomes the visible quiz file name in your workspace. A clear name helps you find the quiz later, especially after you have several files.
